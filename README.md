...
1. Push this project to a GitHub repository and ensure the branch you want to deploy (e.g. `main`) is up to date.
2. Go to [vercel.com](https://vercel.com) and sign in with GitHub.
3. Click **Add New** -> **Project** and import your GitHub repository.
4. Vercel will detect Vite and set **Build Command**: `npm run build` and **Output Directory**: `dist`. Confirm these (or set them if not auto-detected).
5. (Optional) Set **Root Directory** if the app lives in a subfolder of the repo.
